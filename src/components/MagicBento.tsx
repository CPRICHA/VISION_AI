...
// Use accent-primary blue (#29A3FF) as RGB
const DEFAULT_GLOW_COLOR = "41, 163, 255";
...
const createParticleElement = (x: number, y: number, color = DEFAULT_GLOW_COLOR): Particle => {
...
const ParticleCard = ({
  ...
  const memoizedParticles = useRef<Particle[]>([]);
  ...
  const animateParticles = useCallback(() => {
    ...
    memoizedParticles.current.forEach((particle, index) => {
      const timeoutId = window.setTimeout(() => {
        ...
        const clone = particle.cloneNode(true) as Particle;
